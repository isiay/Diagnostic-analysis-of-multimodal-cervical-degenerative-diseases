...
data = dict(
    workers_per_gpu=2,
    train_dataloader=dict(samples_per_gpu=24), # modify fine tune
    val_dataloader=dict(samples_per_gpu=1),
    test_dataloader=dict(samples_per_gpu=1),
    train=dict(
        type='BottomUpCocoDataset',  
        ann_file=f'{data_root}/annotations/person_keypoints_train2017.json', # modified 
        img_prefix=f'{data_root}/train2017/', # modified
        data_cfg=data_cfg,
    ...
    val=dict(
        ...
        img_prefix=f'{data_root}/val2017/', # modified
        data_cfg=data_cfg,
